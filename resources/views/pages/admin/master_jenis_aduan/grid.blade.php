...
<div class="nk-fmg-body-head d-none d-lg-flex">
    ...
    <div class="nk-fmg-actions">
        <div class="btn-group">
            <a href="{{ route('master_jenis_aduan.create') }}" class="btn btn-sm btn-primary" onclick="buttondisable(this)"><em class="icon fas fa-plus"></em> <span>Add Data</span></a>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    table = $('#{{$table_id}}').DataTable({
        ...
        ajax: {
            url: '{{ route("master_jenis_aduan.grid") }}',
            type:"POST",
